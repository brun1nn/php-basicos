...
// Inicializa a variável $cliente como null (VIA GET)
$cliente = null;

// Verfica se o ID foi passado via URL para edição
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
// Verifica se o formulário foi enviado para atualizar o cliente (VIA POST)
